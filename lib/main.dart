...
import 'package:auhackathon/firebase_options.dart';
    ...
    return MaterialApp(
      ...
      home: riverpod.Consumer(
        builder: (context, ref, _) {
          final userProvider = ref.watch(userInfoAuthProvider);
...
//       logo: Image.asset('assets/images/giphy.gif'),
//       // logo: Image.asset('assets/images/background_image.jpg'),
